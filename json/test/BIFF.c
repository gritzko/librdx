...
ok64 BIFFtestMergeIdentityLeft() {
    ...
    a_dup(u8c, ld, u8bDataC(left_buf));
    a_dup(u8c, rd, u8bDataC(right_buf));
    call(BASONMerge, out_buf, out_idx, lstk, ld, rstk, rd);

    a_dup(u8c, od, u8bDataC(out_buf));
...
ok64 BIFFtestDiffIdentical() {
    ...
    a_dup(u8c, od, u8bDataC(old_buf));
    a_dup(u8c, nd, u8bDataC(neu_buf));
...
ok64 BIFFtestDiffRoundtrip() {
    ...
    a_dup(u8c, od2, u8bDataC(old_buf));
    a_dup(u8c, dd, u8bDataC(diff_buf));
    call(BASONMerge, merge_buf, merge_idx, lstk2, od2, rstk2, dd);

    a_dup(u8c, md, u8bDataC(merge_buf));
...
static ok64 BIFFCheckJSONEqual(u8csc a_data, u8csc b_data) {
    ...
    a_dup(u8c, aj, u8bDataC(abuf));
    a_dup(u8c, bj, u8bDataC(bbuf));
